...
type LayoutRouteId = RouteId | "/" | "/dashboard/admin" | "/dashboard/admin/questionnaires" | "/dashboard/admin/questionnaires/[id]" | "/dashboard/admin/statistics" | "/dashboard/admin/users" | "/dashboard/admin/users/[id]" | "/dashboard/admin/workouts" | "/dashboard/admin/workouts/[id]" | "/dashboard/athlete" | "/dashboard/athlete/profile" | "/dashboard/athlete/questionnaires" | "/dashboard/athlete/questionnaires/[id]" | "/dashboard/athlete/settings" | "/dashboard/athlete/workouts" | "/dashboard/athlete/workouts/[id]" | "/dashboard/trainer" | "/dashboard/trainer/athletes" | "/dashboard/trainer/athletes/[id]" | "/dashboard/trainer/questionnaires" | "/dashboard/trainer/questionnaires/[id]" | "/dashboard/trainer/questionnaires/[id]/edit" | "/dashboard/trainer/questionnaires/new" | "/dashboard/trainer/settings" | "/dashboard/trainer/workouts" | "/dashboard/trainer/workouts/[id]" | "/dashboard/trainer/workouts/new" | "/login" | "/privacy" | "/register" | null
