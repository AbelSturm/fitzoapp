...
type LayoutRouteId = RouteId | "/dashboard/admin" | "/dashboard/admin/questionnaires" | "/dashboard/admin/questionnaires/[id]" | "/dashboard/admin/statistics" | "/dashboard/admin/users" | "/dashboard/admin/users/[id]" | "/dashboard/admin/workouts" | "/dashboard/admin/workouts/[id]"
